...
function S.displayBox(text, textSize, rect, foreColour, backColour, textColour)
	--[[ Print text in a box ]]
	textColour = textColour or S.WHITE
	love.graphics.setColor(backColour)
	love.graphics.rectangle("fill", rect.x, rect.y, rect.w, rect.h + 2)
	love.graphics.setColor(foreColour)
	love.graphics.rectangle("line", rect.x, rect.y, rect.w, rect.h)
	if text ~= "" then
		S.drawText(text, textSize, rect.x + 2, rect.y + 3, 'left', textColour)
	end
end
