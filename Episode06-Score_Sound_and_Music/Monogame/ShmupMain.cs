...
namespace Shmup
{
    public class ShmupMain : Game
    {
        /// <summary>
        /// Episode 7 and 8
        /// https://www.youtube.com/watch?v=U8yyrpuplwc
        /// https://www.youtube.com/watch?v=abm1VwFxv9o
        /// Add text and score
        ...
        protected override void LoadContent()
        {
            ...
            LoadAudio();
            LoadFonts();
            Player.CreatePlayer(playerimg: playerImg, scl: 0.5f, spd: 500f);
            random = new Random();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if(Shared.GameState == Shared.GameStates["play"])
            {
                ...
                Shared.DrawString(spriteBatch:spriteBatch, text: Shared.Score.ToString(), size: "size24", posX: 0, posY: 10, color: Color.White);
            }
            if (Shared.Debug)
            {
                Shared.DrawString(spriteBatch: spriteBatch, text:"Debug mode", size:"size14", posX: 15, posY: 20, color:Color.Yellow, align:"left" );
            }
            spriteBatch.End();
            base.Draw(gameTime);
        }
