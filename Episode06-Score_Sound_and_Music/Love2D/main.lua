--[[ 
Lua / Love2D equivalent of Python / Pygame Shmup Episode 7 and 8
...
local function checkMobPlayerCollisions(keyboardState, dt)
	...
	else -- Player dead, but explosion sound may be playing
		if not sounds.die:isPlaying() then
...
function love.draw()
	...
	Shared.drawText(Shared.score, 'size24', Shared.WIDTH / 2, 10)
